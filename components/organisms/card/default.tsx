...
const Card = ({ idol }: Props) => (
  <div className="w-96 m-2 p-6 rounded-lg shadow-md bg-white">
    ...
    <div className="mt-6">
      <ColorInfo type="RGB" value={idol.rgb} tooltip />
      <ColorInfo className="mt-4" type="HSV" value={idol.hsv} tooltip />
      <ColorInfo className="mt-4" type="HEX" value={idol.hex} tooltip />
    </div>
  </div>
)
